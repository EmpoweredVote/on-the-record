...
# audit.py does `from scripts.db import ...`, so `scripts` has to be the skill's package while it
# loads — and must stop being it afterwards, or the repo's own `scripts.*` modules become
