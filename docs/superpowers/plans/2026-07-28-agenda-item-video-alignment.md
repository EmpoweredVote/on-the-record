...
- [ ] **Step 4:** Commit: `feat: alignment anchors + mechanical validation gates`.
...
- [ ] **Step 2:** Full suite green; push; `gh pr create` (title: "Agenda item→video alignment (Pass B): anchor-first spans, gated outcomes, in-place flip"); body summarizing modules, the calibration results table, and the runbook.
